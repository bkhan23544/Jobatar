    ...
    componentDidMount = () => {
        ...
        firebase.auth().onAuthStateChanged(user => {
            ...
            if (user !== null) {
                ...
                let client = (providerData.providerId === 'google.com') ? 'google' : 'facebook';
                dispatch(authActions.loginByAuth(providerData, {authclient: client}));
            } else {
                    ...
                    <div className="login-container container d-flex flex-wrap justify-content-center">
                                        ...
                                        <div className="col-12">
                                            ...
                                            <div className="form-group">
                                                <LaddaButton className="btn btn-info btn-block" loading={this.props.process.loading}
                                                             data-style={EXPAND_RIGHT}>Sign In</LaddaButton>
                                            </div>
                                            {(alert && alert.user_id) &&
                                            <div className="form-group or text-light text-center" style={{fontSize: '12px', marginBottom: '0px'}}>
                        ...
                        <div className="login-bg order-md-1 d-flex flex-wrap align-items-end"
                            ...
                            <div className="caption">
                                <div className="text">As a freelancer for the past four years, JoBarter is exactly what I need to take my business to
                                    the next level.
                                </div>
